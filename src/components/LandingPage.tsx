        ...
        <div>
          ...
          <div className="mt-10">
            ...
            <button
              ...
              className={`mt-5 w-full flex justify-end text-[13px] font-medium tracking-wide transition-all ${
                canGenerate && !isGenerating ? "text-white/60 hover:text-white cursor-pointer" : "text-white/30 cursor-not-allowed"
              }`}
            ...
            <button
              ...
              disabled={isGenerating}
              className={`mt-4 w-full rounded-xl py-4.5 text-[15px] font-bold tracking-wide transition-all duration-300 ${
                canGenerate && !isGenerating 
                  ? "cursor-pointer shadow-[0_8px_20px_-6px_rgba(200,185,126,0.35)] hover:shadow-[0_12px_24px_-6px_rgba(200,185,126,0.55)] hover:-translate-y-0.5" 
                  : "cursor-not-allowed opacity-60"
              } flex items-center justify-center gap-2.5`}
              style={{
                background: canGenerate && !isGenerating
                  ? "linear-gradient(135deg, #d4c48a 0%, #a8975e 100%)"
                  : "rgba(255,255,255,0.05)",
                color: canGenerate && !isGenerating ? "var(--navy)" : "rgba(255,255,255,0.3)",
                border: canGenerate && !isGenerating ? "none" : "1px solid rgba(255,255,255,0.1)",
              }}
            >
